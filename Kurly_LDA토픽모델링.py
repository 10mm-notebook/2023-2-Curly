...
# CSV 파일에서 데이터 불러오기
title = os.path.basename('C:/Users/zoo55/OneDrive/바탕 화면/DATA/CUK-data-Revised/Data-Revised/Market_kurly.csv')
...
def save_processed_data(processed_data):
    with open("C:/Users/zoo55/Documents/tokenized_data_"+title, 'w', newline="", encoding='utf-8') as f:
        writer = csv.writer(f)
...
if __name__ == '__main__':
    # CSV 파일에서 데이터 읽기
    df = pd.read_csv('C:/Users/zoo55/OneDrive/바탕 화면/DATA/CUK-data-Revised/Data-Revised/Market_kurly.csv')
...
# 시각화를 HTML 파일로 저장
pyLDAvis.save_html(lda_visualization, 'C:/Users/zoo55/Documents/Market_10.html')
